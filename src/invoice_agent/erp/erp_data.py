...
class ERPMockData:
    ...
    def _generate_purchase_orders(self):
        ...
        for i in range(1, 51):  # Generate 50 POs
            ...
            po = {
                ...
                "vendor_info": {"id": vendor["id"], "name": vendor["name"]},
    ...
    def _generate_goods_receipts(self):
        ...
        self.goods_receipts = []  # Clear existing GRs

        for po in self.purchase_orders:
            if po["status"].lower() == "completed":  # Case-insensitive check
        ...
        # Save updated GRs to file
        self._save_data()

    def regenerate_goods_receipts(self):
        """Regenerate goods receipts for all completed POs"""
        self._generate_goods_receipts()
        return len(self.goods_receipts)
    ...
    def get_gr_by_po_number(self, po_number):
        """Get goods receipt data for a specific PO number"""
